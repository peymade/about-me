...
function askName(){
  ...
  userName = prompt('Welcome to Peyton\'s guessing game site. What is your name?');
  ...
  gameAnswer = prompt('Okay ' + userName + ', would you like to play a game to learn more about me? (enter either yes or no.)')
}
